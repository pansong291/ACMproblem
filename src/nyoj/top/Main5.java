...
/*
 * tm: Binary String Matching       --finish
 * 
 * ms: Given two strings A and B, whose alphabet consist only ‘0’ and ‘1’.
 ...
 * 
 * sr: The first line consist only one integer N, indicates N cases follows.
 ...
 * 
 * sc: For each case, output a single line consist a single integer,
